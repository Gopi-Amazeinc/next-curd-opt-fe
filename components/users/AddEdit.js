...
import { NexLink } from '../../components';
...
function AddEdit(props) {
    ...
    function createUser(data) {
        return usercurdService.create(data)
            .then(() => {
    ...
    function updateUser(id, data) {
        debugger
        return usercurdService.update(id, data)
            .then(() => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group">
                ...
                <NexLink href="/users" className="btn btn-link">Cancel</NexLink>
            </div>
        </form>
    );
}